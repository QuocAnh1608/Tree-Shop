                    ...
                    <div class="col-lg-4 col-md-5">
                        <div class="widgets_container widget_app">
                            <div class="footer_logo">
                                <a href="<c:url value='/trangchu'/>"><img src="<c:url value='/images/Slide/logo.jpg'/>" alt=""></a>
                            </div>
                            ...
                            <div class="footer_app">
                                <ul>
                                    <li><img src="<c:url value='/images/Slide/appstore.png'/>" alt=""></li>
                                    <li><img src="<c:url value='/images/Slide/ggplay.png'/>" alt=""></li>
                                </ul>
                            </div>
                        </div>
                    </div>
